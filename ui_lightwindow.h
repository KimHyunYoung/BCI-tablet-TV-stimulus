...
public:
    ...
    void setupUi(QMainWindow *lightwindow)
    {
        ...
        lightwindow->resize(1951, 1210);
        lightwindow->setFocusPolicy(Qt::TabFocus);
        ...
        lineEdit->setGeometry(QRect(1280, 140, 471, 161));
    ...
    {
        lightwindow->setWindowTitle(QApplication::translate("lightwindow", "TV Control", Q_NULLPTR));
        label->setText(QApplication::translate("lightwindow", "<html><head/><body><p><span style=\" font-size:48pt;\">Choose Stimulus type</span></p></body></html>", Q_NULLPTR));
        label_2->setText(QApplication::translate("lightwindow", "<html><head/><body><p><span style=\" font-size:26pt;\">Light Setting</span></p></body></html>", Q_NULLPTR));
        pushButton->setText(QApplication::translate("lightwindow", "Next", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("lightwindow", "Cancel", Q_NULLPTR));
        label_3->setText(QApplication::translate("lightwindow", "Dark time", Q_NULLPTR));
        label_4->setText(QApplication::translate("lightwindow", "Flash Time", Q_NULLPTR));
        label_11->setText(QApplication::translate("lightwindow", "training", Q_NULLPTR));
        label_12->setText(QApplication::translate("lightwindow", "testing", Q_NULLPTR));
        label_13->setText(QApplication::translate("lightwindow", "repeats", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("lightwindow", "10.16.27.208", Q_NULLPTR));
    } // retranslateUi
